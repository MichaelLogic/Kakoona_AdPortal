...
class Builddatavault < ActiveRecord::Migration 
  def change
    ...
    create_table :CampaignBrandGrffks do |t|
      t.references :AdCampaigns, index: true
      t.datetime :time_created
    ...
    create_table :ContentProviderAvatar, :id => false do |t|
      t.references :AvatarGrffks, index: true
      t.references :ContentProviders, index: true
    end
    ...
    create_table :CampaignAudio, :id => false do |t|
      t.references :AdCampaigns, index: true
      t.references :KakoonaAudio, index: true
    end

    create_table :CampaignVideos, :id => false do |t|
      t.references :AdCampaigns, index: true
      t.references :KakoonaVideos, index: true
    end
    ...
    create_table :MerchantAvatar, :id => false do |t|
      t.references :AvatarGrffks, index: true
      t.references :Merchants, index: true
    end
    ...
    create_table :MerchAddresses, :id => false do |t|
      t.references :Merchants, index: true
      t.references :Addresses, index: true
    end
    ...
    create_table :RepAdCampaigns, :id => false do |t|
      t.references :MerchRepresentatives, index: true
      t.references :AdCampaigns, index: true
    end
    ...
    create_table :ContentProviderSocialMedia, :id => false do |t|
      t.references :ContentProviders, index: true
      t.references :SocialMedia, index: true
    end
    ...
    create_table :KakoonaVideos do |t|
      ...
      t.text :meta_tags
      t.references :TenderVideoThums, index: true
    end
