class MerchRepresentativesController < ApplicationController
  ...
  private
    ...
    def merch_representative_params
      params.require(:merch_representative).permit(:Merchants_id, :email, :Precious_id, :screen_name, :first_name, :middle_name, :last_name, :phone, :team_role, :rep_about, :is_active, :AvatarGrffks_id, :auth_token, :date_created, :date_modified, :SocialMedia_id, :last_session_time, :last_session_ip, :Sessions_id)
    end
end
