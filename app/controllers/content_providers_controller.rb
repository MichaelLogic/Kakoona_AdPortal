class ContentProvidersController < ApplicationController
  ...
  private
    ...
    def content_provider_params
      params.require(:content_provider).permit(:email, :screen_name, :first_name, :middle_name, :last_name, :phone, :team_role, :rep_about, :is_active, :auth_token, :last_session_time, :last_session_ip)
    end
end
