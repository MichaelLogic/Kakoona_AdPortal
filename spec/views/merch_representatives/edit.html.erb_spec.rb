...
RSpec.describe "merch_representatives/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit merch_representative form" do
    render

    assert_select "form[action=?][method=?]", merch_representative_path(@merch_representative), "post" do
