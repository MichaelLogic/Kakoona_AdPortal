...
RSpec.describe "kakoona_videos/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit kakoona_video form" do
    render

    assert_select "form[action=?][method=?]", kakoona_video_path(@kakoona_video), "post" do
