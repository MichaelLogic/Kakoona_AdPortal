...
RSpec.describe "kakoona_audios/new", :type => :view do
  before(:each) do
    assign(:kakoona_audio, KakoonaAudio.new(
  ...
  it "renders new kakoona_audio form" do
    render

    assert_select "form[action=?][method=?]", kakoona_audios_path, "post" do
