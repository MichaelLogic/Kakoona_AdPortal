...
RSpec.describe "campaign_brand_grffks/index", :type => :view do
  before(:each) do
    assign(:campaign_brand_grffks, [
      CampaignBrandGrffk.create!(
        :ad_campaign => nil,
  ...
  it "renders a list of campaign_brand_grffks" do
    render
