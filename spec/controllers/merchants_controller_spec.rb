  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved merchant as @merchant" do
        post :create, {:merchant => invalid_attributes}, valid_session
        expect(assigns(:merchant)).to be_a_new(Merchant)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested merchant" do
        merchant = Merchant.create! valid_attributes
        put :update, {:id => merchant.to_param, :merchant => new_attributes}, valid_session
        merchant.reload
    ...
    describe "with invalid params" do
      it "assigns the merchant as @merchant" do
        merchant = Merchant.create! valid_attributes
        put :update, {:id => merchant.to_param, :merchant => invalid_attributes}, valid_session
        expect(assigns(:merchant)).to eq(merchant)
      end
