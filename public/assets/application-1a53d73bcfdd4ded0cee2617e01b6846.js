...
var do_on_load = $(function() {
  ...
  $('#avatar_grffk_direct_upload_url').val(content.url);
  $('#avatar_grffk_attached_file_file_name').val(content.filename);
  $('#avatar_grffk_attached_file_file_path').val(content.filepath);
  $('#avatar_grffk_attached_file_file_size').val(content.filesize);
  $('#avatar_grffk_attached_file_content_type').val(content.filetype);
  });
