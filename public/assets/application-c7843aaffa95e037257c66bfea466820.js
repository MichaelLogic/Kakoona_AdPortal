...
var do_on_load = $(function() {
  ...
  $('#avatar_grffk_upload_file_name').val(content.filename);
  $('#avatar_grffk_attached_file_file_path').val(content.filepath);
  $('#avatar_grffk_upload_file_size').val(content.filesize);
  $('#avatar_grffk_upload_content_type').val(content.filetype);
  });
